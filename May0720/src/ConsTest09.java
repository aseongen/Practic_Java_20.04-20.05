class St{
	static int a =10; //  static 키워드로 정의된 변수 a를 정적 변수라고 한다. 
	                  //정적변수는 클래스명으로 직접 접근 할 수 있다. 그래서 클래스 변수라고도 한다.
...
public class ConsTest09 {
	public static void main(String[] args) {
		...
		St s01= new St(); St s02 = new St();
		 ...
		 System.out.println("s01.a = " + s01.a + ", s02.b: " + s02.b);
	 //s01.b 와 s02.b메모리 주소는 다르다
		 s01.a=100; //정적 변수 a는 생성된 각 객체에 의해서 값을 공유한다
		 System.out.println("s01.a = " + s01.a + ", s02.a: " + s02.a);
